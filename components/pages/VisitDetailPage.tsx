    ...
    try {
      ...
      printWindow.document.write(`
        ...
        <head>
          ...
          <style>
            ${PDF_BASE_STYLES}
            h1 { color: #4b7dba; margin-bottom: 5px; }
            .header { border-bottom: 2px solid #4b7dba; padding-bottom: 15px; margin-bottom: 20px; }
            ...
            .badge-blue { background: #dbe8f4; color: #4b7dba; }
            .badge-gray { background: #f3f4f6; color: #6b7280; }
            .section-title { font-size: 16px; font-weight: 600; color: #4b7dba; margin-bottom: 10px; padding-bottom: 5px; border-bottom: 1px solid #e5e7eb; }
          </style>
        </head>
        <body>
          <div class="header">
        ...
        {TABS.map((t) => (
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-1.5 px-3 py-2 text-sm font-medium transition-colors ${
              tab === t.id ? "bg-teal-cpm text-white" : "text-slate-600 dark:text-zinc-400 hover:bg-slate-50 dark:hover:bg-[#222223]"
