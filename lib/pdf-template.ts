...
export const PDF_BASE_STYLES = `
  ...
  .header { text-align: center; margin-bottom: 30px; padding-bottom: 20px; border-bottom: 2px solid #0010A4; }
  .header h1 { color: #0010A4; margin: 0 0 10px; font-size: 24px; }
  ...
  .section h2 { color: #0010A4; font-size: 18px; margin-bottom: 15px; padding-bottom: 8px; border-bottom: 1px solid #e2e8f0; }
  ...
  .note-item { background: #f8fafc; padding: 12px; border-radius: 8px; margin-bottom: 8px; border-left: 3px solid #0010A4; }
  ...
  return `
    ...
    <body>
      <div style="text-align: center; margin-bottom: 40px;">
        <h1 style="color: #0010A4; font-size: 28px; margin: 0;">Rapport Hebdomadaire</h1>
